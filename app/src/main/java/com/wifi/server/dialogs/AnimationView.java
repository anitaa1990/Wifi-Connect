...
public class AnimationView extends View {
    ...
    private static final int DEFAULT_MOVIEW_DURATION = 3000;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mMovie != null) {
            ...
            setMeasuredDimension(mMeasuredMovieWidth, mMeasuredMovieHeight + 50);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
		 ...
		 */
        mLeft = (getWidth() - mMeasuredMovieWidth);
        mTop = (getHeight() - mMeasuredMovieHeight);
